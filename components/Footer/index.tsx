      ...
      <footer className="wow fadeInUp relative z-10 bg-primary bg-opacity-5 pt-16 md:pt-20 lg:pt-24" data-wow-delay=".1s">
        ...
        <div className=" bg-primary/10 py-8">
          <div className="container flex justify-between">
            <p className="text-center text-base text-body-color dark:text-white">Template by UIdeck and Next.js Templates</p>
            <ul className="block justify-end rounded rounded-bl-[50px] bg-primary px-8 text-white lg:flex lg:space-x-12">
              {menuData.map((menuItem, index) => (
                <li key={menuItem.id} className="group relative">
                  <Link href={menuItem.path} className={`flex py-2 text-base group-hover:opacity-70 dark:text-white lg:mr-0 lg:inline-flex lg:px-0`}>
                    {menuItem.title}
                  </Link>
                </li>
              ))}
